...
library(readr)
setwd("C:/SeminTFG2017/datos_4t16")
...
####Convertimos en factores las variables CCAA, SEXO1, y NAC1, y renombramos estas TRES últimas
...
library(ggplot2)
ggplot(tablas_EPA, aes(x=ACTIVIDAD, y=TOTAL/1000, fill=ACTIVIDAD)) + geom_bar(stat="identity")+
  scale_y_continuous(breaks=seq(1000,18000,by=1000))+
ggtitle("EPA4T Personas mayores de 16 años según su relación con la actividad. ESPAÑA")
...
ggplot(tablas_EPA, aes(x=ACTIVIDAD, y=TOTAL/1000, fill=ACTIVIDAD)) + geom_bar(stat="identity")+
  scale_y_continuous(breaks=seq(1000,18000,by=1000))+
  facet_wrap( ~ CCAA)+
ggtitle("EPA4T Personas mayores de 16 años según su relación con la actividad. CCAA")
